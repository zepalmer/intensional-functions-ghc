...
exhaustiveWarningFlag (ItsCurLambdaExpr _) = Just Opt_WarnIncompleteUniPatterns
exhaustiveWarningFlag (ItsUncLambdaExpr _) = Just Opt_WarnIncompleteUniPatterns
