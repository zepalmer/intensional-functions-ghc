...
checkHiBootIface tcg_env boot_info
  | tcg_mod tcg_env == gHC_PRIM = return tcg_env
    -- Not all things exported by the wired-in GHC.Prim module will have
    -- associated declarations in the Haskell source module generated by
    -- ghcprimopcode so we skip this check for this module.
    -- See Note [The GHC.Prim Story] in utils/genprimopcode/Main.hs.
