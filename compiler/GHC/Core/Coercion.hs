...
mkHomoForAllMCo :: ForAllTyBinder -> MCoercion -> MCoercion
mkHomoForAllMCo _    MRefl    = MRefl
mkHomoForAllMCo bndr (MCo co) = MCo (mkHomoForAllCos [bndr] co)
...
mkHomoForAllCos_NoRefl :: [ForAllTyBinder] -> Coercion -> Coercion
